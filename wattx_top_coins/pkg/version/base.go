...
// When releasing a new version, this file is updated by
// build/generate_version to reflect the new version, is created to point to the commit that updates
...
//go:generate ./../../build/generate_version
