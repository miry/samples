...
def rain_risk(commands)
  ...
  commands.each do |command|
    ...
    value = command[1..].to_i64
    direction = directions[direction_indx]
    case instruction
    when 'F'
      dx, dy = direction[0] * value, direction[1] * value
      x += dx
      y += dy
    when 'N'
      y += value
...
def rain_risk2(commands)
  ...
  commands.each do |command|
    ...
    case instruction
    when 'F'
      wx = directions[1] - directions[3]
      wy = directions[0] - directions[2]
    ...
    when 'L'
      ...
      raise "Unknown command #{instruction} in #{command}"
      break
    end
  end
