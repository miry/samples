...
class Passport
  ...
  def valid? : Bool
    ...
    data["byr"].matches?(/^(19[23456789]\d|200[12])$/) &&
      data["iyr"].matches?(/^20(1\d|20)$/) &&
      data["eyr"].matches?(/^20(2\d|30)$/) &&
      data["hgt"].matches?(/^(1([5678]\d|9[0123])cm|(59|6\d|7[1-6])in)$/) &&
      data["hcl"].matches?(/^#[0-9a-f]{6}$/) &&
